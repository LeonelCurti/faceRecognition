...
class SignIn extends Component {
  ...
  onSubmitSignIn = (e) => {
    e.preventDefault();
    fetch('https://ancient-island-39845.herokuapp.com/signin',{
      method:'post',
          ...
          <div className="col-sm-8 col-md-7 col-lg-6 mx-auto">
            ...
            <form>          
              <div className="form-group">
                <label>Email:</label>
                <input type="email" className="form-control" id="email-address" placeholder="example@example.com" onChange={this.onEmailChange}></input>  
              </div>
              <div className="form-group">
